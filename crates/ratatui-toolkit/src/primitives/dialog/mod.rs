...
pub struct Dialog<'a> {
    ...
    height_percent: f32,
    /// Footer text below the message
    footer: Option<&'a str>,
    /// Footer style
    footer_style: Style,
    /// Whether to show title inside content instead of border
    title_inside: bool,
    /// Whether to render a screen overlay behind the dialog
    overlay: bool,
    /// Style for the overlay background
    overlay_style: Style,
    /// Override color for dialog border
