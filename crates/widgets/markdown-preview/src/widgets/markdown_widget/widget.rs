...
use crate::widgets::markdown_widget::extensions::selection::should_render_line as should_render_collapsed_line;
...
impl<'a> MarkdownWidget<'a> {
    ...
    pub fn selection(&self) -> &crate::widgets::markdown_widget::state::SelectionState {
        &self.selection
    }
...
use crate::widgets::markdown_widget::foundation::elements::{render_with_options, RenderOptions};
use crate::widgets::markdown_widget::foundation::helpers::hash_content;
use crate::widgets::markdown_widget::state::{ParsedCache, RenderCache};
