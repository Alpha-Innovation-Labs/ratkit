...
enum RenderRow {
    HunkHeader(String),
    LinePair {
        left: Option<crate::code_diff::diff_line::DiffLine>,
        right: Option<crate::code_diff::diff_line::DiffLine>,
    },
}

/// Gets the background style for a line.
fn get_line_bg(
    line: Option<&crate::code_diff::diff_line::DiffLine>,
    config: &crate::code_diff::diff_config::DiffConfig,
    theme: &AppTheme,
    is_left: bool,
) -> Style {
