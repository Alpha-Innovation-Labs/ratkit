...
#[derive(Clone, Debug)]
pub struct Row {
    pub cells: Vec<crate::primitives::termtui::vt100::cell::Cell>,
    size: u16,
    wrapped: bool,
}
...
impl Row {
    ...
    pub fn clear(&mut self, attrs: crate::primitives::termtui::vt100::attrs::Attrs) {
    ...
    fn cells(&self) -> impl Iterator<Item = &crate::primitives::termtui::vt100::cell::Cell> {
        self.cells.iter()
    }

    pub fn get(&self, col: u16) -> Option<&crate::primitives::termtui::vt100::cell::Cell> {
    ...
    pub fn insert(&mut self, i: u16, cell: crate::primitives::termtui::vt100::cell::Cell) {
    ...
    pub fn erase(&mut self, i: u16, attrs: crate::primitives::termtui::vt100::attrs::Attrs) {
    ...
    pub fn resize(&mut self, len: u16, cell: crate::primitives::termtui::vt100::cell::Cell) {
