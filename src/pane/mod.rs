...
impl<'a> Pane<'a> {
    /// Create a new pane with given title
    ...
    /// Render the pane with given content widget (no footer widget)
    ...
    /// Build title line with optional icon
    ...
    /// Build block with title and optional text footer
