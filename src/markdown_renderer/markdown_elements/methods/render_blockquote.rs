...
use super::super::{MarkdownElement, TextSegment, BLOCKQUOTE_MARKER};
use super::helpers::{render_text_segment, wrap_text};
...
pub fn render(
    ...
    // Each level adds "▋ " (marker + space), so 2 chars per level
...
pub fn blockquote_prefix_width(depth: usize) -> usize {
    depth * 2 // Each level adds "▋ " which is 2 chars
}
