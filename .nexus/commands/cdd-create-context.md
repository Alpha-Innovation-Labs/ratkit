...
You are creating context specification(s) following `.cdd/rules/context.md`.
...
After creating the context file(s), read any rules in `.cdd/rules/` that are relevant to implementation. Common rules:
- `.cdd/rules/context.md` - Context file standards
