...
```toml
[dependencies]
ratkit = { version = "0.2.8", features = ["all"] }
```
...
```toml
[dependencies]
ratkit = { version = "0.2.8", default-features = false, features = ["markdown-preview", "tree-view", "button"] }
```
...
```toml
ratkit = { version = "0.2.8", default-features = false, features = ["tree-view", "toast"] }
```
