...
```toml
[dependencies]
ratkit = { version = "0.2.9", features = ["all"] }
```
...
```toml
[dependencies]
ratkit = { version = "0.2.9", default-features = false, features = ["markdown-preview", "tree-view", "button"] }
```
...
```toml
ratkit = { version = "0.2.9", default-features = false, features = ["tree-view", "toast"] }
```
